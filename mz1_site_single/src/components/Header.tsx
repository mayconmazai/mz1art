...
export default function Header() {
  return (
    <header className="bg-gradient-to-r from-indigo-700 to-purple-700 text-white py-4 shadow-md">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="relative flex items-center justify-center">
              <div className="bg-gradient-to-l from-transparent to-white rounded-[100%] scale-80 absolute z-0 w-[calc(115%+0.125rem)] h-[calc(140%+0.125rem)]"></div>
              <img
                src={mz1FullLogo}
                alt="MZ1 ART Logo"
          ...
          <div className="flex flex-col md:flex-row items=center gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>Curitiba, PR, Brasil | Remoto</span>
            </div>
            <div className="flex items-center gap-2">
